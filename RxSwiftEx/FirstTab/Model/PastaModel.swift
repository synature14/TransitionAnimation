...
class PastaModel {
    ...
    init(image: UIImage, title: String, price: String, weight: String, explain: String) {
        self.image = image
        self.title = title
        self.price = price
        self.weight = weight
    ...
    static func getItems() -> [PastaModel] {
        let ex01 = PastaModel(image: UIImage(named: "barilla")!,
        ...
        let ex02 = PastaModel(image: UIImage(named: "classico")!,
        ...
        let ex03 = PastaModel(image: UIImage(named: "eggNoodles")!,
                              title: "EggNoodles",
                              price: "$11.52",
                              weight: "1kg",
        ...
        let ex04 = PastaModel(image: UIImage(named: "fettuccine")!,
                              title: "Fettuccine",
                              price: "$11.52",
                              weight: "480g",
        ...
        let ex05 = PastaModel(image: UIImage(named: "hunts")!,
                              title: "Tomato Sauce",
                              price: "$11.52",
                              weight: "500g",
        ...
        let ex06 = PastaModel(image: UIImage(named: "prego")!,
        ...
        let ex07 = PastaModel(image: UIImage(named: "senza")!,
